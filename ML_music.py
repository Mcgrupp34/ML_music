#Original code sourced from https://github.com/burliEnterprises/tensorflow-music-generator
# and https://github.com/dshieble/Music_RBM
...
# Set to folder holding midi_manipulation.py
import sys
...
songs = get_songs('path_to_folder_with_midi_files_for_training')
...
num_timesteps = 15  # This is the number of timesteps create at a time
n_visible = 2 * note_range * num_timesteps  # This is the size of the visible layer.
n_hidden = 50  # This is the size of the hidden layer

num_epochs = 500 # The number of training epochs

batch_size = 100  # The number of training examples .
